    ...
    <div class="d-flex">
        ...
        <div class="container-xl px-4 mt-4">
            <nav class="nav nav-borders">
                <a class="nav-link" :class="{ active: activeTab === 'eventList' }"
                    @click.prevent="changeTab('eventList')">Event List</a>
                <a class="nav-link" :class="{ active: activeTab === 'eventForm' }"
                    @click.prevent="changeTab('eventForm')">Event Form</a>
            </nav>
            <hr class="mt-0 mb-4">
                                ...
                                <tr v-for="event in eventList" :key="event.id">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-outline-primary btn-sm"
                                            @click="openEditForm(event.id)">Edit</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <form @submit.prevent="handleSubmit">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-3">
                                            ...
                                            <input class="form-control" id="eventName" type="text"
                                                placeholder="Enter event name" v-model.trim="formData.eventName">
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input class="form-control" id="address" type="text"
                                                placeholder="Enter address" v-model.trim="formData.address">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="small mb-1" for="citySelect">Location</label>
                                            <select id="citySelect" class="form-control"
                                                v-model.trim="formData.locationId">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-6 w-25">
                                            ...
                                            <input class="form-control" id="maxAttendees" type="number"
                                        ...
                                        <div class="col-md-6 w-50">
                                            ...
                                            <input class="form-control" id="description" type="text"
                                                placeholder="Enter description" v-model.trim="formData.description">
                                        </div>
                                    </div>
                                    <div class="row gx-3 mb-3">
                                        <div class="col-md-12">
                                            <div class="card mb-4 mb-xl-0">
                                                ...
                                                <div class="card-body text-center" style="align-self: center;">
                                                    <div class="image-container"
                                                        ...
                                                        <div v-if="!imageUrl" class="placeholder">No Image Selected
                                                        </div>
                                                    </div>
                                                    <div class="small font-italic text-muted mb-4">Upload your Event
                                                        Image</div>
                                                    <input class="form-control" id="file" type="file" ref="fileInput"
                                                        @change="handleImageUpload" style="display: none;">
                                                    <button class="btn btn-outline-primary" type="button"
                                                        @click="$refs.fileInput.click()">Upload new image</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Submit Button -->
                                    <button class="btn btn-primary" type="submit">{{ isEditMode ? 'Update' : 'Submit'
                                        }}</button>
                                </form>
                            </div>
                        </div>
